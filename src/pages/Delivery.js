...
const Content = () => {
    ...
    >
      ...
      <IconButton className={classes.icon} type="submit"  aria-label="search">
        ...
        <Grid item xs={4}>
          <Button className={classes.gridbtns} variant="contained"   >Order ID</Button>
        ...
        <Grid item xs={4}>
          <Button className={classes.gridbtns} variant="contained"   >Table 5</Button>
          
        </Grid>
        <Grid item xs={4}>
          <Button className={classes.gridbtns} variant="contained"   >Table 6</Button>
          
        </Grid>
        <Grid item xs={4}>
          <Button className={classes.gridbtns} variant="contained"   >Table 7</Button>
